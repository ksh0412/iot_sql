...
<c:url var="tableInfoUrl" value="/db/table/info" /> //jsp:include 와 같음(action)
	...
	var cnt=0;
		$("#query").keydown(function(e){
			...
			if(e.ctrlKey && keyCode==120 && e.shiftKey){
				sql=this.value;
				var cursor=this.selectionStart; //커서가 있는 위치부터 시작
				var startSql=sql.substr(0,cursor);
				var startSap=startSql.lastIndexOf(";") //뒤에서부터 ";"이 있는지 확인
